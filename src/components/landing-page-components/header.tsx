  ...
  return (
    <div className="fixed top-0 z-999 w-full">
      <header
        ...
        className="group border-b-section-outline relative h-(--header-height) border-b before:absolute before:inset-0 before:backdrop-blur-xs"
      >
