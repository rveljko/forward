...
function Item({
  ...
  return (
    <li
      className={cn(
        'has-[button]:text-clickable has-[a]:text-clickable has-[button]:hover:bg-clickable/10 has-[button]:pointer-coarse:active:bg-clickable/10 has-[a]:hover:bg-clickable/10 has-[a]:pointer-coarse:active:bg-clickable/10 relative flex items-center gap-2 px-4 py-2 transition-[background-color]',
        className
      )}
      {...props}
    >
