...
export default function PanelCard({
  ...
  return (
    <article
      className={cn(
        'ring-section-outline has-[button]:hover:ring-clickable/20 has-[button]:pointer-coarse:active:ring-clickable/20 has-[label]:pointer-coarse:active:ring-clickable/20 has-[a]:pointer-coarse:active:ring-clickable/20 has-[label]:hover:ring-clickable/20 has-[a]:hover:ring-clickable/20 relative overflow-hidden rounded-lg p-2 ring has-[a]:active:scale-99 has-[button]:active:scale-99 has-[label]:active:scale-99',
        className
      )}
      {...props}
    >
