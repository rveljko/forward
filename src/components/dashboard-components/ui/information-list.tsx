...
function Value({ children, icon: Icon, className, ...props }: ValueProps) {
  return (
    <div className="hover:border-section-outline flex items-center gap-1 rounded-sm border border-dashed border-transparent px-1.5 py-0.5 hover:bg-neutral-800">
