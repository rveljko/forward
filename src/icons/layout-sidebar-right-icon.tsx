type LayoutSidebarRightIconProps = {
  className?: string
}

export default function LayoutSidebarRightIcon({
  className,
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        rx="1"
        fill="currentColor"
        className="transition-all duration-200 ease-in-out [clip-path:_polygon(100%_0,_100%_0,_100%_100%,_100%_100%)]"
      />
    </svg>
  )
}
