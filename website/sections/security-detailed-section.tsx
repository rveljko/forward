    ...
    <Section className="mt-8 border-t border-t-neutral-200 py-4 md:py-8">
      ...
      <div className="flex flex-col items-center gap-6 md:gap-8">
        <div className="relative isolate flex w-full justify-center px-4">
          ...
          <ul className="flex w-full max-w-5xl flex-col divide-y divide-dashed divide-neutral-200 rounded-lg border border-neutral-200 bg-white @2xl:flex-row @2xl:divide-x @2xl:divide-y-0">
