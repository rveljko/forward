...
const button = cva(
  'flex w-max items-center justify-center gap-1 rounded-md font-medium text-black shadow-sm transition hover:cursor-pointer active:scale-99 pointer-coarse:select-none [&_svg]:size-4',
  {
    variants: {
      variant: {
        primary:
