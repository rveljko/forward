        ...
        {templates.map(({ label, description, icon: Icon, color }, index) => {
          ...
          return (
            ...
            >
              <article
                className={cn(
                  'flex translate-x-[calc(-200%-(var(--gap)*2))] flex-col rounded-lg bg-white opacity-0 shadow-sm ring ring-black/10 transition-transform duration-(--transition-duration) [--gap:--spacing(4)]',
                  isAfterPrevious &&
                    'translate-x-[calc(200%+(var(--gap)*2))] opacity-100',
                  isPrevious &&
                    'translate-x-[calc(100%+var(--gap))] opacity-100',
                  isActive && 'translate-x-0 -translate-y-4 opacity-100',
                  isNext && 'translate-x-[calc(-100%-var(--gap))] opacity-100'
                )}
              >
        ...
        {templates.map(({ title, content: Content }, index) => {
          ...
          return (
            ...
            >
              <article
                className={cn(
                  'flex w-full translate-x-[calc(-200%-(var(--gap)*2))] flex-col opacity-0 transition-transform duration-(--transition-duration) [--gap:--spacing(8)]',
                  isAfterPrevious &&
                    'translate-x-[calc(200%+(var(--gap)*2))] opacity-100',
                  isPrevious &&
                    'translate-x-[calc(100%+var(--gap))] opacity-100',
