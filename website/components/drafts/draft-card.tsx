...
export default function DraftCard({
  ...
  return (
    <article className="relative flex h-full flex-col overflow-hidden rounded-md shadow-sm ring ring-neutral-900/10 hover:cursor-pointer hover:ring-neutral-900/20 pointer-coarse:transition pointer-coarse:active:scale-99 pointer-coarse:active:ring-neutral-900/20">
      <div className="overflow-hidden rounded-t-md rounded-b-sm border border-white">
        <div
          className={cn(
            'h-18 w-full transition-colors',
