...
export default function DashboardLayout() {
  ...
  return (
    <div
      id="dashboard-layout"
      className={`relative flex h-screen overflow-hidden bg-neutral-100 text-sm text-neutral-900 antialiased ${preferences.isRightSideSidebar ? 'flex-row-reverse' : 'flex-row'}`}
    >
      <Toaster />
      <div
