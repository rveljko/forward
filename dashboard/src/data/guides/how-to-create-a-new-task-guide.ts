export const howToCreateANewTaskGuide = `## How to Create a New Task

Tasks help you organize your work by keeping track of personal to-dos and smaller action items. Follow these steps to create a new task:

1. **Open the Tasks Page:**
   In the sidebar, click on the **Tasks** page

2. **Open the Create New Task Modal:**
