...
const button = cva(
  'relative flex w-max items-center justify-center gap-1 rounded-md font-medium text-nowrap text-black shadow-sm transition hover:cursor-pointer not-disabled:active:scale-99 disabled:cursor-not-allowed disabled:opacity-50 disabled:select-none',
  {
    variants: {
      variant: {
        primary:
