...
export default function NavigationLink({
  ...
  return (
    <NavLink
      className={({ isActive }) =>
        cn(
          'flex items-center gap-1 rounded-md px-1.5 py-1 font-medium text-black transition hover:bg-neutral-200 active:scale-99 pointer-coarse:active:bg-neutral-200',
          '[&_svg]:size-4 [&_svg]:text-neutral-600 hover:[&_svg]:text-black pointer-coarse:active:[&_svg]:text-black',
          isActive &&
