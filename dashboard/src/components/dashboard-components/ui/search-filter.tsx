...
export default function SearchFilter({
  ...
  return (
    <label
      className={cn(
        'flex w-max items-center gap-1 rounded-md px-2 py-1 text-xs shadow-sm ring inset-ring ring-neutral-900/10 inset-ring-white transition hover:cursor-pointer hover:ring-neutral-900/20 active:scale-99',
        checked &&
