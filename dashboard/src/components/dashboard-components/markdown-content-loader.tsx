  ...
  return (
    <Markdown
      components={{
        h1: ({ node, ...props }) => (
          <h1
            className="mb-2 text-2xl font-medium has-[+_h2]:mb-8 md:text-3xl"
            {...props}
          />
        ),
        h2: ({ node, ...props }) => (
        ...
        ul: ({ node, ...props }) => (
          <ul
            className="mb-2 ml-6 list-disc space-y-1.5 has-[+_h2]:mb-8 has-[+_h3]:mb-8"
            {...props}
          />
        ),
        ol: ({ node, ...props }) => (
          <ol
            className="mb-2 ml-6 list-decimal space-y-1.5 has-[+_h2]:mb-8 has-[+_h3]:mb-8"
            {...props}
          />
        ),
        li: ({ node, ...props }) => (
